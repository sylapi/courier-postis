    ...
    public static function successCreateParcelProvider(): array
    {
      ...
      $addresses = [
        ...
        return [
            ...
            [CourierCode::GLS->value, null, 'correct', ['address' => $addresses['de']['correct'], 'sender' => $sender['pl']]], 
            [CourierCode::INPOST->value, null, 'correct', ['address' => $addresses['pl']['correct'], 'sender' => $sender['pl'],  'options' => $options['inpost_pickup_point']]], 
            [CourierCode::OLZA->value, OlzaCourierCode::GLS->value, 'local_phone_number', ['address' => $addresses['cz']['local_phone_number'], 'sender' => $sender['pl']]], 
